...
- **Manager mode.** Take charge of any of the 48 nations for the whole tournament, one match at a time. Pick the shape, drag your eleven onto the pitch, set the mentality and scout every opponent, and manage stamina and bookings across the month. A live tracker shows your group table, the qualification race and your knockout path. At the final whistle your run is graded against the model's own expectation for the team, with a shareable poster of the campaign.
