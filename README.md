...
- **1248 real players** from the official 2026 squads, each with a real photo, an overall calibrated to current form, projected elevens, a goalscorer model, and per-game player ratings.
